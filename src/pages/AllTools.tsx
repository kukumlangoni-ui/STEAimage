  ...
  const categories = [
    {
      ...
      tools: [
        ...
        { title: "Convert to JPG", description: "Convert any image format to JPG.", icon: FileType2, to: "/tools/convert-to-jpg" },
        { title: "Convert from JPG", description: "Convert JPG images to other formats.", icon: ImageIcon, to: "/tools/convert-from-jpg" },
        { title: "WebP Converter", description: "Convert to and from modern WebP format.", icon: Zap, to: "/tools/to-webp" },
      ],
    },
    {
      id: "document-tools",
    ...
    },
    {
      ...
      tools: [
        ...
        { title: "Social Media Resizer", description: "Resize images for all social platforms.", icon: Smartphone, to: "/tools/social-media" },
