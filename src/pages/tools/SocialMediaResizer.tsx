...
const PLATFORMS = [
  { name: "Instagram Square", width: 1080, height: 1080, icon: Instagram },
  { name: "Instagram Portrait", width: 1080, height: 1350, icon: Instagram },
  ...
  { name: "Twitter Post", width: 1600, height: 900, icon: Twitter },
  ...
  { name: "TikTok Video", width: 1080, height: 1920, icon: Video },
              ...
              <div className="mt-6 space-y-6 border-t border-white/5 pt-6">
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      { id: "contain", icon: Minimize, label: "Fit" },
                      { id: "cover", icon: Maximize, label: "Fill" },
                      { id: "fill", icon: StretchHorizontal, label: "Stretch" },
                    ].map((mode) => (
                      <button
                        key={mode.id}
