  ...
  const processImage = async () => {
    ...
    try {
      ...
      img.onload = async () => {
        ...
        setResultUrl(canvas.toDataURL("image/webp", quality / 100));
        setStatus("success");
    ...
    <div className="mx-auto w-full max-w-7xl px-6 py-12">
      ...
      <div className="mb-12 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-white leading-[0.9] mb-4 break-words">
          Image to <span className="text-amber-500 text-stroke-sm text-transparent">WebP</span>
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-lg font-medium text-zinc-400">
          Convert any image to WebP format for superior compression and faster web performance.
        </p>
      </div>
                ...
                <div className="rounded-xl bg-amber-500/5 p-4 border border-amber-500/10">
                  <div className="flex gap-3">
                    ...
                    <p className="text-[10px] leading-relaxed text-zinc-400">
                      WebP images are significantly smaller than JPGs and PNGs while maintaining high quality.
                    </p>
                  </div>
                </div>
              </div>
